...
/**
 * FacturaslineasId entity. @author MyEclipse Persistence Tools
 */

public class FacturaslineasId implements java.io.Serializable {
	...
	/** default constructor */
	public FacturaslineasId() {
	}

	/** full constructor */
	public FacturaslineasId(Empresas empresas, Ejercicios ejercicios,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FacturaslineasId))
			return false;
		FacturaslineasId castOther = (FacturaslineasId) other;
