 ...
 * @author WinDoctor
 */
public class FacturaLiquidacionParaCopia 
{
	private static File WORKING_DIRECTORY;
    private Connection conn;
    private Object parent;
    
    public FacturaLiquidacionParaCopia(Object parent)
    {        
        try 
        {
            ...
            try {
                ...
                if(url.getProtocol().equals("file")) {
                  ...
                  if(url.getProtocol().equals("jar")) {
                    String expected = "/reportsPackage/FacturaLiquidacionConCopia.jasper";
    		...
    		Date fechaDesde, Date fechaHasta, Integer numerofacturadesde, Integer numerofacturahasta)
    {
        ...
        {       
            ...
            if (master == null)          
	            ...
	            System.out.println("WARNING: FacturaLiquidacionParaCopia - verificar referencias DB en .jrxml");
