...
public class ListadoPersonal 
{
    ...
    public ListadoPersonal(java.awt.Frame parent)
    {        
        try 
        {
        ...
        {
        	Message.ShowErrorMessage(parent, "ListadoPersonal", ex.getMessage());
        } 
        catch (SQLException ex) 
        {
        	...
        	Message.ShowErrorMessage(parent, "ListadoPersonal", e);
        }
    ...
    public static File getDirectory() {
        if(WORKING_DIRECTORY == null) {
            ...
            try {
                URL url = ListadoPersonal.class.getResource("ListadoPersonal.jasper");  
                if(url.getProtocol().equals("file")) {
                  ...
                  if(url.getProtocol().equals("jar")) {
                    String expected = "/reportsPackage/ListadoPersonal.jasper";
                    ...
                    */
                    ...
                    /**
                    *Extrayendo una nueva subcadena eliminando "/reportsPackage/ListadoPersonal.jasper"
                    */
    ...
    public void runReporte(int empresa, int ejercicio)
    {
        ...
        {            
            ...
            String master =  workDirectory + 
            			"\\reportsPackage\\ListadoPersonal.jasper";
            
            if (master == null) 
            	Message.ShowErrorMessage(parent, "ListadoPersonal", "No encuentro el archivo del informe maestro.");
            else {
        ...
        {
        	Message.ShowErrorMessage(parent, "ListadoPersonal", "Mensaje de Error: " + j.getMessage());
        }
    ...
    public void cerrar()
    {
                ...
                {
                	Message.ShowErrorMessage(parent, "ListadoPersonal", ex);
                }
    }
}
