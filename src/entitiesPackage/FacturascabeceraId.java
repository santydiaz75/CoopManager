...
/**
 * FacturascabeceraId entity. @author MyEclipse Persistence Tools
 */

public class FacturascabeceraId implements java.io.Serializable {
	...
	/** default constructor */
	public FacturascabeceraId() {
	}

	/** full constructor */
	public FacturascabeceraId(Empresas empresas, Ejercicios ejercicios,
			Integer idFactura) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FacturascabeceraId))
			return false;
		FacturascabeceraId castOther = (FacturascabeceraId) other;
