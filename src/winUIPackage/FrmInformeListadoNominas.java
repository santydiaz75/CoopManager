 ...
 * @author  __USER__
 */
public class FrmInformeListadoNominas extends javax.swing.JDialog {
	...
	public FrmInformeListadoNominas(java.awt.Frame parent, MySession session,
			boolean modal) {
		super(parent, modal);
		try {
	...
	private void initComponents() {
		...
		setTitle("Informe de listado de n�minas");
		setResizable(false);
	...
	private void btnOkMousePressed(java.awt.event.MouseEvent evt) {
		try {
			if (validateData()) {
				...
				ListadoNominas report = new ListadoNominas(parent);
			...
			Message.ShowRuntimeError(parent,
					"FrmInformeListadoNominas.btnOkMousePressed()", he);
		}
	}
