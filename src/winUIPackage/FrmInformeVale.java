...
import reportsPackage.InformeValeGrupo;
 ...
 * @author  __USER__
 */
public class FrmInformeVale extends javax.swing.JDialog {
	...
	public FrmInformeVale(java.awt.Frame parent, MySession session,
			boolean modal) {
		super(parent, modal);
		try {
			...
			Message.ShowRuntimeError(parent, "FrmInformeVale()", he);
		}
	}
	...
	private void configureKeys() {
		try {
			...
			Message
					.ShowRuntimeError(parent, "FrmInformeVale.configureKeys",
							he);
		}
	}
	...
	private boolean validateData() {
		...
		try {
			...
			if (txtSemanaDesde.getText().equals("")) {
				Message.ShowValidateMessage(parent,
						"Debe indicar la semana de inicio.");
			...
			Message.ShowRuntimeError(parent, "FrmInformeVale.validateData()",
					he);
			return (false);
		}
	}
	...
	private void initComponents() {
		...
		lblEsGrupo = new javax.swing.JLabel();
		chkEsGrupo = new javax.swing.JCheckBox();

		setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
		setTitle("Informe de vale de entrada");
		setResizable(false);
		...
		txtCosechero.setBorder(javax.swing.BorderFactory
				.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
		txtCosechero
				.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
						new javax.swing.text.NumberFormatter(
		...
		lblEsGrupo.setFont(new java.awt.Font("Segoe UI", 1, 14));
		lblEsGrupo.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
		lblEsGrupo.setText("Marcar si es un grupo");

		chkEsGrupo.setBorder(javax.swing.BorderFactory
				.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
		chkEsGrupo.setMargin(new java.awt.Insets(0, 0, 2, 2));
		chkEsGrupo.setName("privada");
				...
				.setHorizontalGroup(layout
						...
						.addGroup(
								layout
										.createSequentialGroup()
										.addGap(45, 45, 45)
										.addComponent(lblEsGrupo)
										.addPreferredGap(
												javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(chkEsGrupo)
	...
	private void btnOkMousePressed(java.awt.event.MouseEvent evt) {
		try {
			if (validateData()) {
				...
				if (chkEsGrupo.isSelected()) {
					InformeValeGrupo report = new InformeValeGrupo(parent);
					report.runReporte(session.getEmpresa().getIdEmpresa(), session
							.getEjercicio().getEjercicio(), ((Number) txtCosechero
							.getValue()).intValue(), ((Number) txtSemanaDesde
							.getValue()).intValue(), ((Number) txtSemanaHasta
							.getValue()).intValue());
				}
				else {
					InformeVale report = new InformeVale(parent);
					report.runReporte(session.getEmpresa().getIdEmpresa(), session
							.getEjercicio().getEjercicio(), ((Number) txtCosechero
							.getValue()).intValue(), ((Number) txtSemanaDesde
							.getValue()).intValue(), ((Number) txtSemanaHasta
			...
			Message.ShowErrorMessage(parent,
					"FrmInformeVale.btnOkMousePressed()", e);
		}
	}
	...
	private void btnCancelMousePressed(java.awt.event.MouseEvent evt) {
		try {
			...
			Message.ShowRuntimeError(parent,
					"FrmInformeVale.btnCancelMousePressed()", he);
		}
	}
	...
	private javax.swing.JLabel lblEsGrupo;
