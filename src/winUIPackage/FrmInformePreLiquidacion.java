...
import reportsPackage.PreLiquidacion;
 ...
 * @author  __USER__
 */
public class FrmInformePreLiquidacion extends javax.swing.JDialog {
	...
	/** Creates new form FrmInformePreLiquidacion */
	public FrmInformePreLiquidacion(java.awt.Frame parent, MySession session,
			boolean modal) {
		super(parent, modal);
		try {
			...
			Message.ShowRuntimeError(parent, "FrmInformePreLiquidacion()",
					he);
		}
	}
	...
	private void configureKeys() {
		try {
			...
			Message.ShowRuntimeError(parent,
					"FrmInformePreLiquidacion.configureKeys", he);
		}
	}
	...
	private boolean validateData() {
		...
		try {
			...
			Message.ShowRuntimeError(parent,
					"FrmInformePreLiquidacion.validateData()", he);
			return (false);
		}
	}
	...
	private void initComponents() {
		...
		setTitle("Informe de preliquidación");
		setResizable(false);
	...
	private void btnOkMousePressed(java.awt.event.MouseEvent evt) {
		try {
			if (validateData()) {
				...
				PreLiquidacion report = new PreLiquidacion(parent);
			...
			Message.ShowRuntimeError(parent,
					"FrmInformePreLiquidacion.btnOkMousePressed()", he);
		}
	}
	...
	private void btnCancelMousePressed(java.awt.event.MouseEvent evt) {
		try {
			...
			Message.ShowRuntimeError(parent,
					"FrmInformePreLiquidacion.btnCancelMousePressed()", he);
		}
	}
