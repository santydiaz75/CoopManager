 ...
 * @author SANTI DIAZ
 */
public class FrmCategorias extends FrmEntityView  {

	private static final long serialVersionUID = 1L;
    
    public FrmCategorias(java.awt.Frame parent, MySession session) {
    	super(EntityType.EntitiesType.Categorias, parent, session, true, false);
    	try {
    		showEntity();
