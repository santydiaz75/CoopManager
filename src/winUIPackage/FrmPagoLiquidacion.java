...
import entitiesPackage.LiquidacionespagosId;
 ...
 * @author  __USER__
 */
public class FrmPagoLiquidacion extends javax.swing.JDialog {
	...
	public static class DetalleTableModel extends DefaultTableModel {
		...
		final public static int columnComision = 6;

		static String[] columnNames = { "Select", "State", "Fecha", "Concepto",
				"CuentaBancaria", "Importe", "Comision" };
	...
	public FrmPagoLiquidacion() {
		initComponents();
	}

	public FrmPagoLiquidacion(MySession session, Integer idCosechero) {
		try {
			initComponents();
			...
			Message.ShowRuntimeError(pnlData, "FrmPagoLiquidacion()", he);
		}
	}
	...
	private void configureKeys() {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.configureKeys", he);
		}
	}
	...
	private void prepareTable() {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.prepareTable()", he);
		}
	}
	...
	private void newLineDetalle() {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.newLineDetalle()", he);
		}
	...
	private static void changeEditState() {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.changeEditState()", he);
		}
	}
	...
	private void loadCuentasBancarias() {
		...
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.loadCuentasBancarias()", he);
		}
	}
	...
	public void loadData() {
		try {
			...
			Message.ShowRuntimeError(pnlData, "FrmPagoLiquidacion.loadData()",
					he);
		}
	}
	...
	private void loadDataDetail() {
		...
		try {
			...
			List<?> lineasList = entity.executeQuery(this, "*",
					"Liquidacionespagos", "id.idCosechero=" + idCosechero,
					"id.pago");
			...
			if (lineasList.size() == 0)
				...
				for (Object linea : lineasList) {
					Liquidacionespagos pago = (Liquidacionespagos) linea;
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.loadDataDetail()", he);
		}
	}
	...
	public boolean saveData(Boolean showmessage) {
		try {
			...
			Message.ShowRuntimeError(pnlData, "FrmPagoLiquidacion.saveData()",
					he);
			return false;
		} catch (ParseException e) {
			Message.ShowParseError(pnlData, "FrmPagoLiquidacion.saveData()", e);
			return false;
		}
	}
	...
	private boolean validateDetalleData() {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.validateDetalleData()", he);
			return (false);
		}
	}
	...
	private void calculaTotales() {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.calculaTotales()", he);
		}
	}
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				...
				pnlData, javax.swing.GroupLayout.PREFERRED_SIZE, 900,
				javax.swing.GroupLayout.PREFERRED_SIZE));
	...
	private void btnCloseMousePressed(java.awt.event.MouseEvent evt) {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.btnCancelMousePressed()", he);
		}
	}
	...
	private void cmdDeleteLineaMousePressed(java.awt.event.MouseEvent evt) {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.cmdDeleteLineaMousePressed()", he);
		}
	}
	...
	private void cmdDeselectAllMousePressed(java.awt.event.MouseEvent evt) {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.cmdDeselectAllMousePressed()", he);
		}
	}
	...
	private void cmdSelectAllMousePressed(java.awt.event.MouseEvent evt) {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.cmdSelectAllMousePressed()", he);
		}
	}
	...
	private void tblDetalleKeyPressed(java.awt.event.KeyEvent evt) {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.tblDetalleKeyPressed()", he);
		}
	}
	...
	private void btnOkMousePressed(java.awt.event.MouseEvent evt) {
		try {
			...
			Message.ShowRuntimeError(pnlData,
					"FrmPagoLiquidacion.btnOkMousePressed()", he);
		}
	}
