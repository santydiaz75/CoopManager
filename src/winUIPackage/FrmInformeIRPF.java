 ...
 * @author  __USER__
 */
public class FrmInformeIRPF extends javax.swing.JDialog {
	...
	public FrmInformeIRPF(java.awt.Frame parent, MySession session,
			boolean modal) {
		super(parent, modal);
		try {
			...
			Message.ShowRuntimeError(parent, "FrmInformeIRPF()", he);
		}
	}
	...
	private void configureKeys() {
		try {
			...
			Message
					.ShowRuntimeError(parent, "FrmInformeIRPF.configureKeys",
							he);
		}
	}
	...
	private boolean validateData() {
		...
		try {
			...
			Message.ShowRuntimeError(parent, "FrmInformeIRPF.validateData()",
					he);
			return (false);
		}
	}
	...
	private void initComponents() {
		...
		setTitle("Informe de relaci�n de I.R.P.F.");
		setResizable(false);
	...
	private void btnOkMousePressed(java.awt.event.MouseEvent evt) {
		try {
			...
			Message.ShowRuntimeError(parent,
					"FrmInformeIRPF.btnOkMousePressed()", he);
		} catch (ParseException e) {
	...
	private void btnCancelMousePressed(java.awt.event.MouseEvent evt) {
		try {
			...
			Message.ShowRuntimeError(parent,
					"FrmInformeIRPF.btnCancelMousePressed()", he);
		}
	}
