 ...
 * @author  __USER__
 */
public class FrmInformeIGIC extends javax.swing.JDialog {
	...
	public FrmInformeIGIC(java.awt.Frame parent, MySession session,
			boolean modal) {
		super(parent, modal);
		try {
			...
			Message.ShowRuntimeError(parent, "FrmInformeIGIC()", he);
		}
	}
	...
	private void configureKeys() {
		try {
			...
			Message
					.ShowRuntimeError(parent, "FrmInformeIGIC.configureKeys",
							he);
		}
	}
	...
	private boolean validateData() {
		...
		try {
			...
			Message.ShowRuntimeError(parent, "FrmInformeIGIC.validateData()",
					he);
			return (false);
		}
	}
	...
	private void initComponents() {
		...
		setTitle("Informe de relaciï¿½n de I.G.I.C.");
		setResizable(false);
		...
		try {
			if (validateData()) {
				...
				report.runReporte(session.getEmpresa().getIdEmpresa(), session
						.getEjercicio().getEjercicio(), fechadesde, fechahasta);
				Cursor normalCursor = new Cursor(Cursor.DEFAULT_CURSOR);
				setCursor(normalCursor);
			}
		} catch (RuntimeException he) {
			Message.ShowRuntimeError(parent,
					"FrmInformeIGIC.btnOkMousePressed()", he);
		} catch (ParseException e) {
			e.printStackTrace();
		}
	}
	...
	private void btnCancelMousePressed(java.awt.event.MouseEvent evt) {
		try {
			...
			Message.ShowRuntimeError(parent,
					"FrmInformeIGIC.btnCancelMousePressed()", he);
		}
	}
