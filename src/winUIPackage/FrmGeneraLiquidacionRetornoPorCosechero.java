...
public class FrmGeneraLiquidacionRetornoPorCosechero extends javax.swing.JDialog {
	...
	private void configureKeys() {
		...
		try {
            ...
            if (txtNumeroKilos.getText().equals("")) {
				Message.ShowValidateMessage(parent, "Debe indicar el n�mero de kilos a bonificar.");
            ...
            if (txtEjericioContable.getText().equals("")) {
				...
				Message.ShowValidateMessage(parent, "Debe indicar un n�mero de la bonificaci�n en el a�o contable.");
            ...
            if (txtTitulo.getText().equals("")) {
				Message.ShowValidateMessage(parent, "Debe indicar un t�tulo.");
    ...
    private void initComponents() {
        ...
        setTitle("Generaci�n de liquidaciones por cosechero");
        ...
        lblCosechero.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        txtCosechero.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        lblEjercicio.setText("Generar la liquidaci�n de Retorno por Cosechero");
        ...
        lblNumeroKilos.setText("N�mero kilos");
        ...
        txtNumeroKilos.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        lblNumeroBonificacion.setText("N�mero bonificaci�n");
        ...
        txtTitulo.setName("titulo"); // NOI18N
        ...
        txtConcepto.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        txtConcepto.setName("concepto"); // NOI18N
    ...
    private void txtConceptoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTituloKeyTyped
        // TODO add your handling code here:
