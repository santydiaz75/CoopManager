...
public class FrmDataQuery extends javax.swing.JInternalFrame {
	...
	private void loadEntradas() {
		...
		try {
			...
			if (EntradasList.size() > 0) {
				...
				tblEntradas.getColumn("Pi�as").setPreferredWidth(
						EntityType.NumberWidth);
				...
				tblEntradas.getColumn("Pi�as").setCellRenderer(rightRenderer);
			...
			headerDataEntCategorias.add("Categor�as");
			...
			if (EntCategoriasList.size() > 0) {
				...
				tblEntCategorias.getColumn("Categor�as").setPreferredWidth(
						EntityType.TextWidth);
	...
	private void loadVentas() {
		...
		try {
			...
			headerDataVenCategorias.add("Categor�as");
			...
			if (VenCategoriasList.size() > 0) {
				...
				tblVenCategorias.getColumn("Categor�as").setPreferredWidth(
						EntityType.TextWidth);
	...
	private void initComponents() {
		...
		lblTotalPinasEntradas
				.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
		lblTotalPinasEntradas.setText("Total pi�as");
		...
		lblKilosvsPinas
				.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
		lblKilosvsPinas.setText("Kilos/Pi�as");
