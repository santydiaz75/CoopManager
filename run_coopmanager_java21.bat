...
"C:\Users\santy\.maven\maven-3.9.11\bin\mvn" clean compile exec:java -Dexec.mainClass="winUIPackage.Launcher" -Dfile.encoding=UTF-8 -Duser.language=es -Duser.country=ES
